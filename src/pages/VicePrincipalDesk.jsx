...
import VicePrincipalImg from "../assets/management/dummy.jpg"
...
const VICE_PRINCIPAL_SECTIONS = [
    {
        heading: "Welcome to SR. L.S. International Public School!",
        body:
            "As Vice Principal, I'm excited to welcome you. At SR. L.S., we're committed to providing an innovative and engaging learning experience for every student.",
    },
    {
        heading: "Fostering Curiosity and Creativity",
        body:
            "We believe in fostering curiosity, igniting a passion for learning, and empowering students to embrace challenges. Our dedicated team is committed to providing a cutting-edge education that prepares students for the demands of tomorrow. We encourage exploration, creativity, and the development of essential 21st-century skills. We deeply value the collaboration with parents and the community in shaping our students' future. Explore our website to see how SR.L.S. is preparing students for success. We're confident it's a place where innovation and inspiration meet.",
    },
];
...
export default function VicePrincipalMessage() {
    return (
        <>
        <PageHeaderBanner crumbs={["Management", "Vice Principal Desk"]} title="Message from Vice Principal" />
                        ...
                        <div className="[perspective:1200px]">
                            <div className="group cursor-pointer">
                                ...
                                <div className="mt-5">
                                    ...
                                    {/* <p className="text-[#737477] text-[15px] mt-1">Vice Principal</p> */}
                                </div>
                            </div>
                        </div>
